...
__global__
void bpe_baseline_global( uint32_t ** input_base, uint32_t ** input_length, uint32_t ** input,
...
void FSTGPU::bpe_baseline_host(){
	printf("Begin bpe_baseline_host \n ");
	...
	bpe_baseline_global<<< number_of_block,number_of_thread>>> ( partition_input_base, partition_input_length, input,  partition_output_base,  simulated_output, printed_output);
